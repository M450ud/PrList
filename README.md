...
A [Sing-Box](https://github.com/SagerNet/sing-box/releases "Sing_Box App release page") config which created using above configs is avalible at [Sing-Box Config file](sing-box://import-remote-profile?url=https://raw.githubusercontent.com/M450ud/PrList/main/nekobox_backup.json#Masoud Config "Sing-Box Config file") and sample NekoBox config for initialzation is at [nekobox config backup](https://raw.githubusercontent.com/M450ud/PrList/main/nekobox_backup.json "nekobox config") link which file must be downladed an import to app.
