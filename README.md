...
A [Sing-Box](https://github.com/SagerNet/sing-box/releases "Sing_Box App release page") config which created using above configs is avalible at [Sing-box Config](https://raw.githubusercontent.com/M450ud/PrList/refs/heads/main/config.json "Sing-box Config"). For auto importing config click [ Here ](https://tinyurl.com/m450udsbj "Sing-box Config")
and sample NekoBox config for initialzation is at [nekobox config backup](https://raw.githubusercontent.com/M450ud/PrList/main/nekobox_backup.json "nekobox config") link which file must be downladed an import to app.
